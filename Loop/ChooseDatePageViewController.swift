//
//  ChooseDatePageViewController.swift
//  carpoolApp_v1.0
//
...
class ChooseDatePageViewController: UIPageViewController {
    private(set) lazy var orderedViewControllers: [UIViewController] = {
        return [self.newPageViewController("MonthOne"),
                self.newPageViewController("MonthTwo"),
                self.newPageViewController("MonthThree")]
    }()
...
extension ChooseDatePageViewController: UIPageViewControllerDataSource {
