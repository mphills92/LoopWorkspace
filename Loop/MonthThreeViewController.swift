...
class MonthThreeViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func viewWillDisappear(animated: Bool) {
        NSNotificationCenter.defaultCenter().removeObserver(self, name: "userCanceledTimeSelectionNotificationMonthThree", object: self.view.window)
    }
}

extension MonthThreeViewController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        cell.numericDate.text = calendarMonthThree.monthDates[indexPath.item]
