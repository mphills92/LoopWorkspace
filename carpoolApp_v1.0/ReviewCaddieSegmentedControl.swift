//
//  ReviewCaddieSegmentedControl.swift
//  carpoolApp_v1.0
//
...
@IBDesignable class ReviewCaddieSegmentedControl: UIControl {
    ...
    override func layoutSubviews() {
        ...
        pillView.frame = CGRectMake ((labelWidth * 0.22), 0, (labelWidth * 0.56), labelHeight)
